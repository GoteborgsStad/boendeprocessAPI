      ...
      <tr>
        ...
        <td class="container">
          <div class="content">
            ...
            <span class="preheader">Notifikation</span>
            <table class="main">
              ...
              <tr>
                <td style="text-align: center; padding-top: 40px !important;">
                  ...
                  <h2 style="margin-bottom: 10px;">Dags att fylla i månadskollen för alla ungdomar!</h2>
                </td>
              </tr>
                ...
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0" style="min-height: auto !important">
                    <tr>
                      <td>
                        <p>Hej {{ $firstName }}!</p>
                        <p>Nu är det dags att fylla i månadens utvärderingar för samtliga ungdomar. Logga in på <a href="{{ $url }}" style="color: #f18700 !important;">sambuh.se</a> för att ta del av tidigare utvärderingar samt för att fylla i nya.</p>
