            ...
            <table class="main">
              ...
              <tr>
                <td style="text-align: center; padding-top: 40px !important;">
                  ...
                  <h2 style="margin-bottom: 10px;">En ungdom har markerat ett uppdrag som avklarat!</h2>
                </td>
              </tr>
                ...
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0" style="min-height: auto !important">
                    <tr>
                      <td>
                        <p>Hej {{ $firstName }}!</p>
                        <p>En av dina ungdomar har markerat ett uppdrag som avklarat och inväntar nu godkännande. Logga in på <a href="{{ $url }}" style="color: #f18700 !important;">sambuh.se</a> för att granska detta uppdrag.</p>
